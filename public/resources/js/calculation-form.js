...
$(document).ready(function () {
    ...
    $('#calculator_form_paymentStartDate').on('focusout blur keyup change', function () {
        $('.invalid-date').remove();
        $('#calculator_form_paymentEndDate').parent('.input-group').removeClass('has-error');
    ...
    allNextBtn.click(function (e) {
        ...
        if (!isValid) {
            ...
            e.returnValue = true;
            var nextStep = curStep.next('.accordion-card');
            if (nextStep) {
                var scrollPos = ($('#accordionExample').offset().top - $('.navbar').outerHeight());
    ...
    $(document).on('click', '.btn-prev', function () {
        ...
        var curStep = $(this).closest(".accordion-card");
        var prevStep = curStep.prev('.accordion-card');
        if (prevStep) {
            var scrollPos = ($('#accordionExample').offset().top - $('.navbar').outerHeight());
            $(window).scrollTop(scrollPos);
        }
